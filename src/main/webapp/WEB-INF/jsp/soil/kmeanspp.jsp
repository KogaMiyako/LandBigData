...
<div style="margin-top: 10px">
    <div class="panel panel-danger table-font">
        ...
        <div class="panel-heading">KMeans++，上传文件请以txt文件格式上传，以空格区分数据。</div>
...
<div class="form-group">
    <input type="file" name="file" id="al1_1File" multiple class="file" data-upload-url="soilFile/upload?algMode=12"
...
<div class="input-group" id="cmdDiv">
    ...
    <span class="input-group-btn">
            <button type="button" class="btn btn-success"
                    id="runButton" onclick="runKMeanspp()">运行算法</button>
    </span>
</div>