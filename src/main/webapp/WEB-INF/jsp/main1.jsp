...
<!-- BEGIN BODY -->
<body class="page-header-fixed" id="root">
<!-- BEGIN HEADER -->
<div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="header-inner">
        ...
        <%--<a href="ranking" id="rankbar">
            <li role="presentation" class="dropdown nav navbar-nav navbar-box" style="margin-right: 0px;">
                <p class="text-center navbar-box-p">排行榜</p>
            </li>
        </a>--%>
        <!--
        <a id="discussbar">
    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" id="page-sidebar-menu">
                ...
                <li class="">
                    <a href="javascript:;">
                        <i class="glyphicon glyphicon-cloud" style="vertical-align: middle"></i><span class="title"> 土壤大数据算法 </span>
                        <span class="arrow "> </span>
                    </a>
                    <ul class="sub-menu" id="algorithmlib">
                        <li>
                            <a href="soilAlgorithm/pollutionResource" id="pollutionResource">
                                污染溯源算法
                            </a>
                        </li>
                        <li>
                            <a href="soilAlgorithm/siteSelect" id="siteSelect">
                                检测选址算法
                            </a>
                        </li>
                        <li>
                            <a href="soilAlgorithm/classificationOne" id="classificationOne">
                                垃圾分类算法一
                            </a>
                        </li>
                        <li>
                            <a href="soilAlgorithm/classificationTwo" id="classificationTwo">
                                水面污染物识别算法
                            </a>
                        </li>
                    </ul>
                ...
                <li class="">
                    <a href="javascript:;">
                        <i class="glyphicon glyphicon-cloud" style="vertical-align: middle"></i><span class="title"> 大数据基础算法库 </span>
                        <span class="arrow "> </span>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="soilAlgorithm/kmeans" id="KKKMeans">
                                KMeans算法
                            </a>
                        </li>
                        <li>
                            <a href="soilAlgorithm/kmeanspp" id="KKKMeanspp">
                                KMeans++算法
                            </a>
                        </li>
                ...
                <li class="">
                    <a href="javascript:;">
                        <i class="fa fa-gears" style="vertical-align: middle"></i><span class="title"> 开放式景区视图 </span>
                        <span class="arrow"> </span>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a class="landmore1" href="soilSample/dumpIntro">
                                场景信息
                            </a>
                        </li>
                        <li>
                            <a class="landmore2" href="soilSample/cameraShow">
                                数据展示
                            </a>
                        </li>
                    </ul>
                ...
                <li class="">
                    <a href="javascript:;">
                        <i class="fa fa-gears" style="vertical-align: middle"></i><span class="title">采摘园场景视图 </span>
                        <span class="arrow "> </span>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="soilSample/cherryIntro" id="clusterinfo">
                                场景信息
                            </a>
                        </li>
                        <li>
                            <a href="soilSample/organicShow" id="nodelist">
                                数据展示
                            </a>
                        </li>
                    </ul>
                ...
                <li class="">
                    <a href="javascript:;">
                        <i class="fa fa-gears"></i><span class="title"> 散户养殖场视图 </span><span
                            class="arrow "> </span>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="soilSample/farmIntro" id="farmInfo">
                                场景信息
                            </a>
                        </li>
                        <li>
                            <a href="soilSample/InorganicShow" id="farmShow">
                                数据展示
                            </a>
                        </li>
                    </ul>
                ...
                <li class="">
                    <a href="javascript:;">
                        <i class="fa fa-user"></i><span class="title"> 土壤防控中心 </span><span
                            class="arrow "> </span>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="user/infoUpdate" id="infoUpdate">
                                个人信息修改
                            </a>
                        </li>
                        <li>
                            <a href="user/algoHistory" id="algoHistory">
                                算法历史报告
                            </a>
                        </li>
                        <li>
                            <a href="user/report" id="report">
                                防控预案信息
                            </a>
                        </li>
                    </ul>
